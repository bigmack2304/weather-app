const WEATHER_API_KEY = process.env.REACT_APP_WEATHER_API_KEY as string; // ключ для взаимодействия с weather API
...
export { WEATHER_API_KEY, WEATHER_API_ADRESS_GEO, WEATHER_API_ADRESS_CURRENT, WEATHER_API_ADRESS_5D3H };
