...
const WEATHER_API_ADRESS_GEO = "http://api.openweathermap.org/geo/1.0/direct"; // базовый адрес для запроса широты и долготы города
const WEATHER_API_ADRESS_CURRENT = "https://api.openweathermap.org/data/2.5/weather"; // базовый адрес для запроса текущей погоды

export { WEATHER_API_KEY, WEATHER_API_ADRESS_GEO, WEATHER_API_ADRESS_CURRENT };
