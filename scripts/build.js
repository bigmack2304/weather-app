...
process.env.GENERATE_SOURCEMAP = process.env.NODE_ENV === "production" ? "false" : "true";
    ...
    .then(
        ...
        (err) => {
            ...
            if (tscCompileOnError) {
                console.log(
                    chalk.yellow("Compiled with the following type errors (you may want to check these before deploying your app):\n")
                );
                printBuildError(err);
            } else {
